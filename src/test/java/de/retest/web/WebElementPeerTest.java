...
class WebElementPeerTest {
	...
	@BeforeEach
	void setUp() {
		cut = new WebElementPeer( mock( RetestIdProvider.class ), null, null, null );
	}
	...
	void retrieveStateAttributes_should_not_contain_null() {
		...
		final WebElementPeer cut = new WebElementPeer( mock( RetestIdProvider.class ), new WebData( wrappedData ),
				"path", mock( DefaultValueFinder.class ) );
