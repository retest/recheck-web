...
public class RecheckSeleniumAdapterTest {
	...
	@Test
	public void getParentPath_should_return_null_for_toplevel() {
		assertThat( RecheckSeleniumAdapter.getParentPath( "//HTML[1]" ) ).isNull();
	}

	@Test
	public void getParentPath_should_return_parent_path() {
		assertThat( RecheckSeleniumAdapter.getParentPath( "//HTML[1]/BODY[1]" ) ).isEqualTo( "//HTML[1]" );
	}

	@Test
	public void convertToPeers_should_result_in_valid_tree() throws Exception {
